...
class ScanSerializerTest(TestCase):
    ...
    def scanner_1_scan_1_1(self):
        ...
        self.assertEqual(aenna.last_scan.one_tabler_count, 3)
        self.assertEqual(aenna.last_scan.two_tabler_count, 0)
        self.assertEqual(aenna.last_scan.three_tabler_count, 0)
        self.assertEqual(aenna.last_scan.four_tabler_count, 1)
    ...
    def scanner_1_scan_1_2(self):
        ...
        self.assertEqual(table.last_scan.one_tabler_count, 3)
        self.assertEqual(table.last_scan.two_tabler_count, 0)
        self.assertEqual(table.last_scan.three_tabler_count, 0)
        self.assertEqual(table.last_scan.four_tabler_count, 1)
    ...
    def scanner_2_scan_1_1(self):
        ...
        self.assertEqual(table.last_scan.one_tabler_count, 1)
        self.assertEqual(table.last_scan.two_tabler_count, 1)
        self.assertEqual(table.last_scan.three_tabler_count, 0)
        self.assertEqual(table.last_scan.four_tabler_count, 0)
